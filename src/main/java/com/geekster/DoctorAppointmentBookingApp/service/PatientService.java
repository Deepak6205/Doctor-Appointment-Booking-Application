...
public class PatientService {
    ...
    public String patientSignUp(Patient patient) {
        ...
        //check if valid use or if already exist -> Not allowed : try logging in
        ...
        try {
            ...
            //and finally we save patient in the patient table
            patientRepo.save(patient);
            return "patient registered";
        } catch (NoSuchAlgorithmException e) {
            return "Internal Server issue while saving, try again letter!!!!";
        }
    ...
    public String patientSignIn(SignInInputDto signInInput) {
        ...
        //then sign in only if this person ever signed up.
